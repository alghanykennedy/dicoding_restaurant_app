...
RestaurantsDetailModel restaurantsDetailModelFromJson(String str) =>
    RestaurantsDetailModel.fromJson(json.decode(str));

String restaurantsDetailModelToJson(RestaurantsDetailModel data) =>
...
class RestaurantsDetailModel {
  ...
  factory RestaurantsDetailModel.fromJson(Map<String, dynamic> json) =>
      RestaurantsDetailModel(
